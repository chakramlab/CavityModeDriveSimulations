...
log_file = "logs/All_Mode_0_p_4_Prep_upper.log"
...
Base.redirect_stdio(stdout = log_file, stderr = log_file) do 
    for i in 1:10
        ...
        SC.Dynamics.RunPulseSequence(Model, ρ, Model.Stuff["Drive_Sequences"]["Prep_0_+_4"], c_ops = c_ops, run_name = "Mode$(i)_Prep_0_p_4_upper_$name_time", save_path = "Data/", spns = 2, other_ds_properties=other_ds_properties)
        #end
