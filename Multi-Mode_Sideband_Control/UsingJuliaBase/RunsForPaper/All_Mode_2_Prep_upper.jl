...
log_file = "logs/All_Mode_2_Prep_upper.log"
...
Base.redirect_stdio(stdout = log_file, stderr = log_file) do 
    for i in 1:10
        ...
        SC.Dynamics.RunPulseSequence(Model, ρ, Model.Stuff["Drive_Sequences"]["Prep_2"], c_ops = c_ops, run_name = "Mode$(i)_Prep_2_upper_$name_time", save_path = "Data/", spns = 2, other_ds_properties=other_ds_properties)
        #end
