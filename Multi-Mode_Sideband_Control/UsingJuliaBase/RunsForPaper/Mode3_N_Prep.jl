...
log_file = "logs/Mode3_N_Prep.log"
...
Base.redirect_stdio(stdout = log_file, stderr = log_file) do 
    for i in 1:4
        ...
        SC.Dynamics.RunPulseSequence(Model, ρ, Model.Stuff["Drive_Sequences"]["Prep_$i"], c_ops = c_ops, run_name = "Mode3_Prep_$i_$start_time", save_path = "Data/", spns = 2, other_ds_properties=other_ds_properties)
        #end
